	...
	<div class="container">
		<div class="column one">
			...
			<div class="top_bar_left clearfix">
			    ...
			    <div class="LogoRightAction">
			        <span class="EmailAction"><i class="fa fa-envelope"></i><p>Email:<?= '<a href="mailto:'. $header_email .'">'. $header_email .'</a>';  ?></span>
			        <span class="PhoneAction"><i class="fa fa-volume-control-phone"></i><p>Call Us:<?= '<a href="tel:'. str_replace(' ', '', $header_phone) .'">'. $header_phone .'</a>';?></p></span>
			        <span class="ContactActionBtn"><a href="#">Contact Us</a></span>
			    </div>
